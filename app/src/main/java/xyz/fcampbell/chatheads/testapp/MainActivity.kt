...
//        bindService(Intent(this, ChatHeadService::class.java), serviceConnection, Context.BIND_AUTO_CREATE)
    ...
    fun prepareDummyChatHeads(): ChatHeadAdapter {
        ...
        val chatHeads = listOf(
                ChatHead(dummyDrawable, TextView(this).apply { text = "Chat head 1" }),
                ChatHead(dummyDrawable, TextView(this).apply { text = "Chat head 2" }),
                ChatHead(dummyDrawable, TextView(this).apply { text = "Chat head 3" }))
